jQuery(function ($) {
    ...
    $("#mw-menu--linkID-1534").click(function () {
        $("#mw-menu--itemID-1534 > .sub-menu li").slideToggle("slow");
    });
    ...
    $("#mw-menu--linkID-1534").hover(
    	function () {
    		$("#mw-menu--linkID-1534 .mw-angle").css("color", "#ffffff");
    	},
    	function() {
    		$("#mw-menu--linkID-1534 .mw-angle").css("color", "#e8b548");
    	});
});